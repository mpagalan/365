...
module ImageHelper
  def image
    File.new(File.join(RAILS_ROOT,"spec", "fixtures","Winter.jpg"), 'rb')
  end
  
  def bad_image
    File.new(File.join(RAILS_ROOT,"spec", "fixtures","bad.png"), 'rb')
  end
  
  def text_file
    File.new(File.join(RAILS_ROOT,"spec", "fixtures","text.txt"), 'rb')
  end
